...
**통과 기준** (configs/validation_config.yaml): bandwidth 상대오차 ≤20%, burst duration ≤30%, hopping interval ≤30%, energy histogram Wasserstein distance ≤ 실측 프레임간 baseline의 2배. 측정은 real/synthetic 모두 동일한 raw-IQ 추정기로 수행(apples-to-apples).
